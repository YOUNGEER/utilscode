...
object AppUtils {
    ...
    private fun getCurrentProcessName(): String {
        ...
        var processName = ""
        val manager = AppUtils.context.getSystemService(Context.ACTIVITY_SERVICE) as (ActivityManager)
     ...
     * @return
     */
    public fun isMainProcess(): Boolean {
        return AppUtils.context.getPackageName().equals(getCurrentProcessName());
    }
